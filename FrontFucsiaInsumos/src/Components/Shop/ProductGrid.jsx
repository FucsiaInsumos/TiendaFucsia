  ...
  <>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      {products.map(product => (
        <div 
          key={product.id} 
          className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 group flex flex-col h-full" // ✅ AGREGADO: flex flex-col h-full
        >
          {/* Imagen del producto - Ahora clickeable */}
          <div 
            className="relative h-48 bg-gray-200 overflow-hidden cursor-pointer flex-shrink-0" // ✅ AGREGADO: flex-shrink-0
          ...
          {/* ✅ CONTENIDO DEL PRODUCTO - CON FLEX PARA EMPUJAR EL BOTÓN HACIA ABAJO */}
          <div className="p-4 flex flex-col flex-grow">
            {/* ✅ SECCIÓN DE CONTENIDO QUE PUEDE CRECER */}
            ...
            {/* ✅ SECCIÓN DEL BOTÓN - SIEMPRE AL FINAL */}
            <div className="mt-auto">
              ...
              {/* ✅ BOTÓN DE AGREGAR AL CARRITO - SIEMPRE EN LA MISMA POSICIÓN */}
              <button
