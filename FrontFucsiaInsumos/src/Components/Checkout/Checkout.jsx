...
import { toast } from 'react-toastify'; // ✅ AGREGAR IMPORT FALTANTE
...
import api from '../../utils/axios'; // ✅ USAR TU AXIOS CONFIGURADO
...
const Checkout = () => {
  ...
  const { 
    ...
    total, 
    subtotal, 
     discount, // NUEVA LÍNEA
    appliedDiscounts, // NUEVA LÍNEA
  ...
  // ✅ FUNCIÓN ACTUALIZADA CON AXIOS
  const handleWompiSuccess = async (transaction) => {
    try {
      console.log('💰 Procesando pago exitoso:', transaction);
      
      // ✅ DATOS IMPORTANTES DE LA TRANSACCIÓN
      const paymentData = {
      ...
      const orderPayload = {
        ...
        orderType: 'online',
        paymentMethod: 'wompi',
        paymentStatus: 'paid', // ✅ MARCAR COMO PAGADO
        paymentDetails: paymentData, // ✅ INCLUIR DETALLES DEL PAGO
        notes: orderData.notes,
        pickupInfo: orderData.pickupInfo,
        // ✅ DATOS ADICIONALES PARA WOMPI
        wompiData: {
          transactionId: transaction.id,
          reference: transaction.reference,
      ...
      console.log('📤 Enviando orden con pago exitoso:', orderPayload);
      ...
      if (response.data.error === false) {
        ...
        toast.success('¡Orden creada exitosamente! Pago procesado correctamente.');
      ...
      // ✅ NO CERRAR EL WIDGET AUTOMÁTICAMENTE, PERMITIR REINTENTO
      console.warn('El pago fue exitoso pero falló la creación de la orden. El usuario puede reintentar.');
    }
  };
  ...
  const handleWompiError = (error) => {
    ...
    const errorMessage = error.reason || error.message || 'Error en el pago';
  ...
  const handleSubmitWithPayment = async () => {
    ...
    try {
      ...
      // ✅ USAR AXIOS EN LUGAR DE DISPATCH DIRECTO
      const response = await api.post('/orders', orderPayload);
  ...
  // ... resto del JSX igual, solo cambié las funciones de manejo
  return (
                ...
                {(showWompiWidget || (isOnlineSale && orderData.paymentMethod === 'wompi')) && (
                  <div className="mt-6 p-4 border border-blue-200 rounded-lg bg-blue-50">
                    ...
                    <WompiWidget
                      ...
                      onClose={() => !isOnlineSale && setShowWompiWidget(false)}
                    />
                  </div>
                )}
              ...
              <div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
                  ...
                  <div className="space-y-2">
                    ...
                    {/* NUEVA SECCIÓN - Descuentos aplicados */}
                    {appliedDiscounts && appliedDiscounts.length > 0 && (
                      <>
                        ...
                        <div className="flex justify-between text-green-600 font-medium pt-1 border-t border-green-200">
