...
import { createUserFromDashboard, updateUser } from '../../../Redux/Actions/authActions';
...
const AdminUserForm = ({ onSuccess, onCancel, initialData = null }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (initialData) {
        await dispatch(updateUser(initialData.n_document, submitData));
      } else {
        await dispatch(createUserFromDashboard(submitData));
      }
